========================================================================
		ActiveX Control DLL : ECT_SOFTPHONE
========================================================================

ControlWizard has created this project for your ECT_SOFTPHONE ActiveX Control
...
that make up your ECT_SOFTPHONE ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
ECT_SoftPhone control:

ECT_SoftPhoneCtl.h
	This file contains the declaration of the CECT_SoftPhoneCtrl C++ class.

ECT_SoftPhoneCtl.cpp
	This file contains the implementation of the CECT_SoftPhoneCtrl C++ class.

ECT_SoftPhonePpg.h
	This file contains the declaration of the CECT_SoftPhonePropPage C++ class.

ECT_SoftPhonePpg.cpp
	This file contains the implementation of the CECT_SoftPhonePropPage C++ class.

ECT_SoftPhoneCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CECT_SoftPhoneCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ECT_SoftPhone.rc.
